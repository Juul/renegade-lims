...
var csv = {
  ...
  getSamples: function(labCore, cb) {
    ...
    stream.on('data', function(data) {
      ...
      str += val.id+','+val.barcode+','+val.formBarcode+','+createdAt+','+val.createdAt+','+createdBy+','+(!!(data.rimbaudSynced))+"\r\n";
    ...
    stream.on('data', function(val) {
      ...
      for(wellName in val.wells) {
        ...
        for(reporter of bgiReporters) {
          ...
          str += val.id+','+val.plateID+','+wellName+','+reporter+','+well.result[reporter]['Sample Name']+','+well.result[reporter].Ct+','+result+','+val.protocol+','+createdAt+','+createdBy+"\r\n";
